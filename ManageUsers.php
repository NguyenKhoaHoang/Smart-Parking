...
<body>
	...
	<main>
		<h1 class="slideInDown animated">Add a new Vehicle User or update information <br> or remove </h1>
		<div class="form-style-5 slideInDown animated">
			<form enctype="multipart/form-data">
				<div class="alert_user"></div>
				<fieldset>
					<legend><span class="number">1</span>Vehicle User Info</legend>
					<input type="hidden" name="id" id="id">
					<input type="text" name="name" id="name" placeholder="User Name...">
					<input type="text" name="vehicle_plate" id="vehicle_plate" placeholder="Vehicle plate...">
